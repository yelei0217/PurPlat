...
public class PushRecordControllerBeanEx extends com.kingdee.eas.custom.app.PushRecordControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.app.PushRecordControllerBeanEx");
    protected void _generPurOrder(Context ctx, IObjectValue model)throws BOSException
    {
	     super._generPurOrder(ctx, model);
    }
    protected void _generPurInBIll(Context ctx, IObjectValue model)throws BOSException
    {
	     super._generPurInBIll(ctx, model);
    }
