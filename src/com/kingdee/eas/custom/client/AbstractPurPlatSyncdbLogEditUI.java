 ...
 * output class name
 */
public abstract class AbstractPurPlatSyncdbLogEditUI extends com.kingdee.eas.framework.client.EditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractPurPlatSyncdbLogEditUI.class);
     ...
     */
    public AbstractPurPlatSyncdbLogEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractPurPlatSyncdbLogEditUI.class.getName());
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.custom.app.PurPlatSyncdbLogEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.custom.PurPlatSyncdbLogInfo)ov;
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.custom.client", "PurPlatSyncdbLogEditUI");
    }
    ...
    {
        return com.kingdee.eas.custom.client.PurPlatSyncdbLogEditUI.class.getName();
    }
