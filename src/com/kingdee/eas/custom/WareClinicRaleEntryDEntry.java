...
public class WareClinicRaleEntryDEntry extends CoreBillEntryBase implements IWareClinicRaleEntryDEntry
{
    public WareClinicRaleEntryDEntry()
    {
        super();
        registerInterface(IWareClinicRaleEntryDEntry.class, this);
    }
    public WareClinicRaleEntryDEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IWareClinicRaleEntryDEntry.class, this);
    }
    ...
    private WareClinicRaleEntryDEntryController getController() throws BOSException
    {
        return (WareClinicRaleEntryDEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getWareClinicRaleEntryDEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getWareClinicRaleEntryDEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getWareClinicRaleEntryDEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getWareClinicRaleEntryDEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getWareClinicRaleEntryDEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getWareClinicRaleEntryDEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
