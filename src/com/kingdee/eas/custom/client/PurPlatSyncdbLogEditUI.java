 ...
 * output class name
 */
public class PurPlatSyncdbLogEditUI extends AbstractPurPlatSyncdbLogEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(PurPlatSyncdbLogEditUI.class);
    
    /**
     * output class constructor
     */
    public PurPlatSyncdbLogEditUI() throws Exception
    {
        super();
    }
    /**
