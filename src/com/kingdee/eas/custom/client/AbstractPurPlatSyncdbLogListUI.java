 ...
 * output class name
 */
public abstract class AbstractPurPlatSyncdbLogListUI extends com.kingdee.eas.framework.client.ListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractPurPlatSyncdbLogListUI.class);
    /**
     * output class constructor
     */
    public AbstractPurPlatSyncdbLogListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractPurPlatSyncdbLogListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.custom.app", "PurPlatSyncdbLogQuery");
        //actionCancel
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.custom.app.PurPlatSyncdbLogListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.custom.client", "PurPlatSyncdbLogListUI");
    }
    /**
