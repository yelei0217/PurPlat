...
public class PurPlatSyncEnum extends StringEnum
{
    ...
    public static final String BACK_NUM_MAX_VALUE = "-8";//alias=退货数量不能大于申请数量
    ...
    public static final PurPlatSyncEnum BACK_NUM_MAX = new PurPlatSyncEnum("BACK_NUM_MAX", BACK_NUM_MAX_VALUE);
