 ...
 * output class name
 */
public abstract class AbstractPushRecordListUI extends com.kingdee.eas.framework.client.ListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractPushRecordListUI.class);
    /**
     * output class constructor
     */
    public AbstractPushRecordListUI() throws Exception
    {
        super();
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.custom.app.PushRecordListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.custom.client", "PushRecordListUI");
    }
