 ...
 * output class name
 */
public abstract class AbstractPurPlatSyncBusLogListUI extends com.kingdee.eas.framework.client.ListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractPurPlatSyncBusLogListUI.class);
    /**
     * output class constructor
     */
    public AbstractPurPlatSyncBusLogListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractPurPlatSyncBusLogListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.custom.app", "PurPlatSyncBusLogQuery");
        //actionCancel
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.custom.app.PurPlatSyncBusLogListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.custom.client", "PurPlatSyncBusLogListUI");
    }
    /**
